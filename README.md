...
|:------|:-----------|:------|:---------|
| **Signal** | Correct $\pi^{0}$ photon pair that matches Monte Carlo truth, identified as the pair with minimum $\chi^2_{M_{\gamma\gamma}}$ value | 1 | True $\pi^{0}\to\gamma\gamma$ decay from $e^{+}e^{-}\to\pi^{+}\pi^{-}\pi^{0}\gamma$ and $e^{+}e^{-}\to\phi\to\eta\gamma\to\pi^{+}\pi^{-}\pi^{0}\gamma$|

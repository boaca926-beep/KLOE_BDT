...
void test_bdt_new() {
    ...
    TH1D* hM2pi_fixed = hists.create("hM2pi_fixed", "", N_BINS_MASS, MASS_2PI_RANGE_MIN, MASS_2PI_RANGE_MAX);
    ...
    // Invariant masses: logarithmic y-axis
    drawTripleOverlay("invariant_masses", "Invariant Masses",
                      hMgg_fixed, hMgg_bdt, hM3pi_fixed, hM3pi_bdt, hM2pi_fixed, hM2pi_bdt,
                      "M_{#gamma#gamma} [MeV/c^{2}]", "M_{3#pi} [MeV/c^{2}]", "M_{2#pi} [MeV/c^{2}]", "Entries", true);

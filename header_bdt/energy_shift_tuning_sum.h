...
const double mpi0_data = 0.0; //From massbias_bdt.txt
const double mpi0_data_err = 0.0;

const double mpi0_mc = 0.0; //From massbias_bdt.txt
const double mpi0_mc_err = 0.0;

const double MASS_SCALE_PI0 = 1.0; //R0 from massbias_bdt.txt

const TString tree_file_nm = "/media/bo/Backup/bdt_output/bdt_tuning_TDATA_chain_false_trk/cut/tree_pre.root";
const TString out_dir = "../tuning_false_m3pi_bdt";
const TString outputSfw2D = "/media/bo/Backup/bdt_output/bdt_tuning_TDATA_chain_false_trk/sfw2d/";
